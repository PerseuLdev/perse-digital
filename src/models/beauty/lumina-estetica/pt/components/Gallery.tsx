  ...
  return (
    <section id="gallery" className="w-full flex flex-col items-center justify-start py-24 bg-white">
      <div className="max-w-3xl text-center px-4 mb-8">
        <h2 className="text-sm font-bold uppercase tracking-widest text-[#C89B6B] mb-2">Portfólio</h2>
        <h3 className="text-3xl md:text-4xl font-semibold text-stone-800">Nossas Últimas Criações</h3>
        <p className="text-sm text-stone-500 mt-4 max-w-xl mx-auto">
          Uma coleção visual dos nossos trabalhos mais recentes. Cada procedimento realizado com
          intenção, segurança e estilo.
        </p>
      </div>
