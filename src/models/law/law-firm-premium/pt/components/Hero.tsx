  ...
  return (
    <div className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-[#050505]">
      ...
      <div className="absolute inset-0 z-0 select-none">
        ...
        <img
            src="https://images.unsplash.com/photo-1505664194779-8beaceb93744?ixlib=rb-4.0.3&auto=format&fit=crop&w=2700&q=80"
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 opacity-0 animate-[slideUp_1s_ease-out_0.6s_forwards]">
                ...
                >
                    <span className="relative z-10 flex items-center justify-center gap-2">
                        <span className="hidden sm:inline">Falar com um Advogado</span>
                        <span className="inline sm:hidden">Consultar Agora</span>
        ...
        <div className="lg:col-span-4 lg:mb-12 space-y-4 opacity-0 animate-[fadeIn_1s_ease-out_0.8s_forwards]">
            <div className="glass-panel p-5 md:p-6 rounded-2xl border border-white/5 hover:border-gold-500/30 transition-colors group">
                ...
                <p className="text-neutral-400 text-[10px] md:text-xs uppercase tracking-widest">Tempo médio de resposta</p>
            </div>
            ...
            <div className="glass-panel p-5 md:p-6 rounded-2xl border border-white/5 hover:border-gold-500/30 transition-colors group">
                ...
                <p className="text-neutral-400 text-[10px] md:text-xs uppercase tracking-widest">Processos Digitais</p>
            </div>
            ...
            <div className="glass-panel p-5 md:p-6 rounded-2xl border border-white/5 hover:border-gold-500/30 transition-colors group">
                ...
                <p className="text-neutral-400 text-[10px] md:text-xs uppercase tracking-widest">Atendimento em todo Brasil</p>
            </div>
        </div>
      </div>
