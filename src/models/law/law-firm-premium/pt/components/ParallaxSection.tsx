...
export const ParallaxSection: React.FC = () => {
  return (
    <section 
      className="relative py-16 md:py-32 parallax-bg bg-fixed bg-center bg-cover"
      style={{
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        <h2 className="font-serif text-2xl md:text-5xl text-white font-light italic leading-tight mb-8">
