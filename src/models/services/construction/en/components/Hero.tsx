        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-md">
              ...
              <span className="text-xs font-medium text-zinc-300 uppercase tracking-wider">Premium Engineering</span>
            </div>
            
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold tracking-tighter leading-[1.05] text-white mb-6">
              We build your project with <span className="text-zinc-500 line-through">no surprises</span>
            </h1>
            
            <p className="text-lg md:text-xl text-zinc-400 mb-10 leading-relaxed max-w-[50ch]">
              We guarantee timeline, budget, and quality. Our engineering team takes the risk so you can enjoy the results.
            </p>
            ...
            <div className="mt-10 flex items-center gap-6">
              ...
              <div className="flex flex-col justify-center">
                ...
                <span className="text-sm tracking-tight text-zinc-400">+120 projects delivered</span>
              </div>
            </div>
          </motion.div>
             ...
             <div className="relative w-full aspect-[4/5] sm:aspect-square lg:aspect-[4/5] rounded-[2.5rem] overflow-hidden border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] bg-zinc-900/50 backdrop-blur-sm">
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-sm font-medium text-zinc-400">Project Status</p>
                      <p className="text-lg font-semibold text-white">100% On Time</p>
