      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="#benefits" className="text-sm font-medium text-zinc-400 hover:text-white transition-colors">Benefits</a>
            <a href="#testimonials" className="text-sm font-medium text-zinc-400 hover:text-white transition-colors">Clients</a>
          </nav>
      ...
      {mobileMenuOpen && (
        ...
        >
          <div className="px-4 pt-2 pb-6 space-y-4">
            <a href="#solutions" className="block text-base font-medium text-zinc-300 hover:text-white pb-2 border-b border-white/5">Solutions</a>
            <a href="#benefits" className="block text-base font-medium text-zinc-300 hover:text-white pb-2 border-b border-white/5">Benefits</a>
            <a href="#testimonials" className="block text-base font-medium text-zinc-300 hover:text-white pb-2 border-b border-white/5">Clients</a>
